...
def load_music_data():
    train_file_name = 'Music/data/train_data.npy'
    valid_file_name = 'Music/data/val_data.npy'
    test_file_name = 'Music/data/test_data.npy'
    datasets = collections.namedtuple('Datasets', ['train', 'validation', 'test'])
    return datasets(train=Dataset(train_file_name), validation=Dataset(valid_file_name), test=Dataset(test_file_name))
