...
class INFO_GAN(BaseModel):
    def __init__(self, logger, gpu_id, learning_rate, loss_type, input_dim, z_dim, ae_h_dim_list, dis_h_dim_list):
        super(INFO_GAN, self).__init__(logger, gpu_id, learning_rate, loss_type, input_dim, z_dim) 
    ...
    def train_with_label(self, sess, batch_xs, batch_ys, epoch_idx, batch_idx, batch_total, log_flag, keep_prob):
         for i in range(5):
    ...
    def inference_with_label(self, sess, batch_xs, batch_ys, epoch_idx, batch_idx, batch_total, log_flag, keep_prob):
    ...
    def inference_with_recon_with_label(self, sess, batch_xs, batch_ys, epoch_idx, batch_idx, batch_total, log_flag, keep_prob):
